...
<html>
    ...
    <body>
        <fieldset>  
            ...
            <ul> <li> <a href="departamento.php">Departamento |</a> </li> </ul>
        ...
        <fieldset>
            <form method="POST" action="insere-departamento.php">
                <legend>Cadastro de departamento</legend>
                <label>Departamento descrição</label>
        ...
        while ($aResultado = pg_fetch_assoc($oResult)) {
            ...
            echo "<td style='border: 1px solid black; borderr-collapse: collapse;'> <a href='delete-departamento.php?dptcodigo=$aResultado[dptcodigo]'> Deletar </a> </td>";
            echo "</tr>";
        }
        echo "</table>";
        echo "</fieldset>";
